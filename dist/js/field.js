  ...
  methods: {
    ...
    syncField: function syncField() {
      ...
      Nova.request().patch(this.syncEndpoint || this.syncFieldEndpoint, this.dependentFieldValues, {
        ...
        cancelToken: new Object(function webpackMissingModule() { var e = new Error("Cannot find module 'axios'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(function (canceller) {
        ...
        if (Object(function webpackMissingModule() { var e = new Error("Cannot find module 'axios'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(e)) {
          return;
        }
        throw e;
      });
    ...
    syncedFieldValueHasNotChanged: function syncedFieldValueHasNotChanged() {
      ...
      return !Object(function webpackMissingModule() { var e = new Error("Cannot find module 'lodash/isNil'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(value) && (value === null || value === void 0 ? void 0 : value.toString()) === ((_this$value = this.value) === null || _this$value === void 0 ? void 0 : _this$value.toString());
    }
  },
  computed: {
    /**
